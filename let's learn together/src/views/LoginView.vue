...
// Only ever redirect to an in-app path — never to an absolute URL supplied
  ...
  <section class="auth-page">
    <div class="auth-card">
      ...
      <form @submit.prevent="onSubmit">
        <label>
          Username
          <input v-model.trim="username" type="text" required placeholder="yourname" autocomplete="username" />
        </label>
