  ...
  <section class="auth-page">
    <div class="auth-card">
      ...
      <form @submit.prevent="onSubmit">
        ...
        <label>
          Password
          <input v-model="form.password" type="password" required minlength="8" placeholder="At least 8 characters" autocomplete="new-password" />
        </label>

        <label>
          Confirm password
          <input v-model="form.password_confirm" type="password" required minlength="8" placeholder="Repeat password" autocomplete="new-password" />
        </label>
